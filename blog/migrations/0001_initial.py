# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-10-26 13:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='专栏名称')),
                ('slug', models.CharField(db_index=True, max_length=256, verbose_name='专栏网址')),
                ('intro', models.TextField(default='', verbose_name='专栏简介')),
            ],
            options={
                'ordering': ['name'],
                'verbose_name': '专栏',
        ...
        migrations.AddField(
            model_name='article',
            name='column',
            field=models.ManyToManyField(to='blog.Column', verbose_name='归属专栏'),
        ),
    ]
